...
namespace utils {
     ...
     */
    inline void getBestClassInfo(const std::vector<float> &p_Mat, const int &numClasses,
...
private:
    ...
    void getBestClassInfo(const std::vector<float> &p_Mat, const int &numClasses, float& bestConf, int& bestClassId) {
        bestClassId = 0;
        bestConf = 0.0f;
